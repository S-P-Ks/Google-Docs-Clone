...
const LinkButton = () => {
  ...
  return (
    ...
    <button className="min-w-7 shrink-0 flex flex-col justify-between items-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
...
const HeadlingLevelButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 min-w-7 w-[120px] shrink-0 flex justify-between items-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
